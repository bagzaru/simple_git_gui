...
2. Git을 통한 파일 관리 기능: Simple-git-gui를 사용하여 Git을 통해 파일을 관리할 수 있습니다. 파일의 상태에 따라 아이콘을 통해 쉽게 확인할 수 있습니다. 파일의 변경사항을 Stage하거나 Unstage하고, 커밋을 생성하고, 파일을 삭제하고, 파일 이름을 변경하는 등의 작업을 할 수 있습니다.

3. 브랜치 관리 기능: Simple-git-gui는 Git 브랜치를 관리할 수 있는 기능을 제공합니다. 브랜치를 추가, 삭제, 이름 변경하고, 브랜치 간에 Merge 작업을 수행할 수 있습니다. 커밋 로그와 그래프를 통해 브랜치 간의 관계를 시각적으로 확인할 수 있습니다.

4. 커밋에 대한 정보 확인: Simple-git-gui를 사용하여 커밋에 대한 정보를 확인할 수 있습니다. 커밋 메시지, 작성자, 시간 등의 정보를 확인할 수 있으며, 변경된 파일의 목록과 변경 내용을 상세히 확인할 수 있습니다.
...
- 클론이 완료되는데 시간이 소요될 수 있습니다.
- 클론 도중에는 다른 기능을 사용하지 말아주세요.
